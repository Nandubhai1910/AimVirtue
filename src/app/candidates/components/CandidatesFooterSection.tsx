...
export default function CandidatesFooterSection() {
  const { play, playButton } = useSoundContext();
  return (
    <footer
      id="footer"
      className="relative z-50 bg-black text-white py-[10vw] md:py-[6vw] px-[6vw] flex flex-col justify-center items-center overflow-hidden select-none"
            ...
            >
              ...
              <span className="inline-block mt-[1vw]">
                <svg
                  ...
                  viewBox="0 0 38 15"
                  className="w-[8vw] sm:w-[5vw] md:w-[3.5vw] h-auto -rotate-90 fill-purple-400 jello-arrow-top"
                >
