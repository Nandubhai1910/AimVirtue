...
export const Home = () => {
  ...
  return (
    <div className="bg-black w-screen h-screen flex flex-col justify-center items-center relative select-none">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_45%,rgba(14,165,233,0.1),transparent_50%)]"></div>
      {/* Canvas container with auto height instead of full screen */}
      <div className="flex w-full justify-center items-center">
        <VaporizeTextCycle
          texts={["Welcome", "To", "AimVirtue"]}
          font={{
            fontFamily: "Inter, sans-serif",
            fontSize: typeof window !== "undefined" && window.innerWidth < 640 ? "38px" : "70px",
            fontWeight: 600,
          }}
      ...
      <p className="mt-4 text-white text-center text-sm sm:text-base md:text-lg lg:text-xl font-heading">
        “Driven by purpose, defined by virtue — AimVirtue.”
      </p>
      <p className="text-gray-600 text-center mt-2 px-2 max-w-4xl mx-auto  font-sans leading-relaxed text-xs sm:text-sm md:text-base">
        “Not just to aim for success, but to aim with virtue — that’s true greatness.
        At AimVirtue, we believe ambition means nothing without integrity,
        and growth means little without purpose.
        From students discovering who they are, to leaders shaping what the world becomes —
        we rise not only to achieve, but to uplift, empower, and evolve with virtue at our core.”
      </p>
